...
def about(request):
    ...
    visitor_cookie_handler(request)
    context_dict['boldmessage'] = 'This tutorial has been put together by Joseph Beattie.'
...
def show_category(request, category_name_slug):
    ...
    try:
        ## Use get for does not exist, or model instance
        category = Category.objects.get(slug=category_name_slug)

        ## Get all related pages or empty list.
        pages = Page.objects.filter(category=category)

        ## Adds result to templates
...
### helper for server side cookies
